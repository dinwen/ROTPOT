...
namespace Rotpot.src.gui
{
    public class HUD
    {
        ...
        {
            batch.Draw(resourceManager.images.GetImage("powerbar"), new Vector2(164 + x, 151 + y) + Main.camera.Position, new Rectangle(0, 0, (int)(((EntityLiving)level.entityManager.GetEntity(0)).GetStrength() / 100f * 339), 36), Color.White, 0f, new Vector2(0, 0), 1, SpriteEffects.None, 0.9f);
